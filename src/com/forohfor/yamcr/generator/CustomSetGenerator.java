...
import com.forohfor.yamcr.model.DescContainer;
...
public class CustomSetGenerator extends JFrame
{
    ...
    public void writeSet()
    {
        ...
        final ProgressTracker tracker = new GuiProgressTracker(RecogApp.INSTANCE.getOpBar());
        if (tracker.startTask("Generating Custom Set...", 1))
        {
            new Thread()
            {
                public void run()
